...
export default function RiderIcon({
  ...
  return (
    ...
    >
      ...
      <path
        fill="url(#deviconRider0)"
        d="M122.514 50.871L40.472 5.339l54.93 81.615l11.288-7.4z"
      />
      <path
        fill="url(#deviconRider1)"
        d="M89.783 32.305L79.506 7.18L56.771 29.562l9.301 81.213L88.1 122.368l34.414-20.102z"
      />
      <path
        fill="url(#deviconRider2)"
        d="M40.472 5.339L5.486 28.904l13.007 80.372l33.548 12.898l43.362-35.218z"
      />
