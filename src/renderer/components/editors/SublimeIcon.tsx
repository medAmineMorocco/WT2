...
export default function SublimeIcon() {
  return (
    <svg
    ...
    >
      <g fill="none">
        ...
        <defs>
          <clipPath id="skillIconsSublimeLight0">
            <path fill="#fff" d="M0 0h256v256H0z" />
          </clipPath>
          <clipPath id="skillIconsSublimeLight1">
            <path fill="#fff" d="M40 40h175v175H40z" />
          </clipPath>
          <linearGradient
            id="skillIconsSublimeLight2"
            x1={7476.84}
            x2={8041.22}
            y1={5387.54}
            y2={3500.4}
