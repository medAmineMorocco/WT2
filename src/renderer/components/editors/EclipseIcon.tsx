...
export default function EclipseIcon({
  ...
  return (
    ...
    >
      ...
      />
      <path
        fill="url(#deviconEclipse0)"
        d="M108.707 60.89a38.413 38.413 0 0 0-1.164-6.78H33.34a38.413 38.413 0 0 0-1.164 6.78Zm0 0"
      />
      <path
        fill="url(#deviconEclipse1)"
        d="M108.707 67.191H32.176c.183 2.29.574 4.559 1.164 6.782h74.203a38.45 38.45 0 0 0 1.164-6.782m0 0"
      />
      <path
        fill="url(#deviconEclipse2)"
