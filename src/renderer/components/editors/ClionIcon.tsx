...
export default function ClionIcon({
  width,
  height,
}: {
  width: string;
  ...
  return (
    ...
    >
      ...
      <path
        fill="url(#deviconClion0)"
        d="M47.555 51.25L50.09 5.484l26.613 14.75Zm0 0"
      />
      <path
        fill="url(#deviconClion1)"
        d="M47.555 51.25L50.09 5.484L16.297 26.781L5.484 91.527Zm0 0"
      />
      <path
        fill="url(#deviconClion2)"
        d="m120.188 40.559l-15.06-30.61l-28.425 10.285L47.555 51.25L5.485 91.527l37.949 27.621l47.703-43.02Zm0 0"
      />
      <path
        fill="url(#deviconClion3)"
        d="M100.57 72.582v27.988H54.613l20.2 15.63l29.257 6.316l18.446-41.754Zm0 0"
      />
      <path d="M27.43 27.43h73.14v73.14H27.43Zm0 0" />
      <path
        fill="#fff"
        d="M36.547 86.746h27.43v4.574h-27.43ZM64.063 36.5h6.093v22.418h12.008V64H64.062ZM34.597 50.434v-.075a14.06 14.06 0 0 1 4.156-10.234a14.06 14.06 0 0 1 10.266-4.078a14.282 14.282 0 0 1 10.898 4.266l-3.84 4.476a10.222 10.222 0 0 0-7.086-3.121c-4.656 0-8.008 3.863-8.008 8.605v.086c0 4.743 3.278 8.692 8.008 8.692c3.172 0 5.098-1.219 7.317-3.242l3.8 3.925a14.138 14.138 0 0 1-11.347 4.875a13.94 13.94 0 0 1-10.082-4.09a13.94 13.94 0 0 1-4.082-10.085"
      />
    </svg>
  );
}
