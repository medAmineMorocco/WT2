...
export default function WebstormIcon({
  width,
  height,
}: {
  width: string;
  ...
  return (
    ...
    >
      ...
      <path
        fill="url(#deviconWebstorm0)"
        d="M21.262 111.25L5.484 17.75L34.656 5.645l18.63 11.07l17.066-9.207l35.558 13.656l-19.94 101.352Zm0 0"
      />
      <path
        fill="url(#deviconWebstorm1)"
        d="M122.516 45.117L107.41 7.813l-27.402-2.33L37.707 46.13L49.09 98.512l21.262 14.91l52.164-30.953l-12.801-24.004Zm0 0"
      />
      <path
        fill="url(#deviconWebstorm2)"
        d="m99.07 39.559l10.645 18.906l12.8-13.348l-9.398-23.234Zm0 0"
      />
